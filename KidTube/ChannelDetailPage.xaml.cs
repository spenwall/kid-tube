...
namespace KidTube
{
    ...
    public sealed partial class ChannelDetailPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            var group = await ChannelDataSource.GetChannelAsync((String)e.NavigationParameter);
            var videos = await ChannelDataSource.GetVideosAsync((String)e.NavigationParameter);
            this.DefaultViewModel["Group"] = group;
            this.DefaultViewModel["Items"] = videos;
            itemsViewSource.Source = new IncrementalVideos((String)e.NavigationParameter);
